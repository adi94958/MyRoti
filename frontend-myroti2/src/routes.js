...
const KelolaDataDataRoti = React.lazy(() => import('./views/koordinator/roti/DataRoti'))
...
const routes = [
  ...
  { path: '/roti', name: 'Roti', element: KelolaDataDataRoti },
  { path: '/roti/tambah', name: 'Tambah Roti', element: FormTambahRoti },
  { path: '/roti/update', name: 'Edit Roti', element: FormUpdateRoti },
]
