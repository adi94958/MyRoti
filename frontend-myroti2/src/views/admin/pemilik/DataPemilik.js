...
const KelolaDataPemilik = () => {
  ...
  const itemsPerPageOptions = [10, 25, 50, dataPemilik.length] // Jumlah data per halaman
  ...
  const endIndex =
    itemsPerPage === dataPemilik.length ? dataPemilik.length : startIndex + itemsPerPage
                    ...
                    >
                      {itemsPerPageOptions.map((option) => (
                        <option key={option} value={option}>
                          {option === dataPemilik.length ? 'All' : option}
                        </option>
                      ))}
                    </CFormSelect>
                  </CCol>
